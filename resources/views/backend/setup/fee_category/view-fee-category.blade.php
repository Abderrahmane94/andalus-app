...
@section('admin')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1><b>فئات الرسوم</b></h1>
                <div class="top-right-button-container">
                    <div class="btn-group">
                        <div class="row">
                            <a href="{{ route('fee.category.add') }}" style="float:left;"
                               class="btn btn-success btn-lg mr-2">إضافة فئة الرسوم</a>
                        </div>
                    </div>
                </div>
                <div class="mb-2">
                    ...
                    @foreach($allData as $key => $data )
                        <tr>
                            ...
                            <td style="text-align: center">
                                <a title="تعديل" href="{{ route('fee.category.edit',$data->id) }}"
                                   class="btn btn-outline-secondary icon-button">
                                    <i class="fa fa-pencil-square-o">
                                    </i>
                                </a>
                                <a title="حذف" href="{{ route('fee.category.delete',$data->id) }}"
