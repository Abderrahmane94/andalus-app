            ...
            <div class="col-12 mb-4 data-table-rows data-tables-hide-filter">
                <table id="datatableRows" class="data-table responsive nowrap"
                    ...
                    <tr>
                        ...
                        <th style="text-align: center">طاقة الاستعاب</th>
                    ...
                    @foreach($allData as $key => $data )
                        <tr>
                            ...
                            <td>
                                <p class="list-item-heading" style="text-align: center">{{$data->nb_students}}</p>
                            </td>
                            <td>
                                <p class="list-item-heading" style="text-align: center">{{$data->surface}}</p>
                            </td>
