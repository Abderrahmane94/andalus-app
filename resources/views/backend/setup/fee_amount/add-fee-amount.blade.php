...
<section class="content">
		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">إضافة مبالغ الرسوم</h4>
	...
	<div class="controls">
	 <select name="fee_category_id" required="" class="form-control">
		<option value="" selected="" disabled="">اختر فئة الرسوم</option>
 ...
 <span class="btn btn-success addeventmore"><i class="fa fa-plus-circle"></i> </span>
  ...
  <input type="submit" class="btn btn-rounded btn-info mb-5" value="إضافة" style="float: left">
						</div>
                        </div>
                      </div>
					</form>
