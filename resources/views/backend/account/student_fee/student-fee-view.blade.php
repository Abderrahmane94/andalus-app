...
@section('admin')
 ...
 <div class="content-wrapper">
                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="code_student" required class="form-control">
                                          </div>
                                      </div>
                                  </div> <!-- End Col md 4 -->
	...
	<a href="{{ route('student.fee.add') }}" style="float: left;" class="btn btn-rounded btn-success mb-5"> إضافة / تعديل رسوم الطلبة</a>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
